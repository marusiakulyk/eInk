...
int main(void)
{
	...
	printf("**********************************************************\r\n");
	TaskHandle_t updScrTsk;
	xTaskCreate(eInkTask,"eInkTask", 200,  0,  2,  &updScrTsk);
//	vTaskSuspend(updScrTsk);
	xTaskCreate(ble_task_process, "ble_update", 200, (void*) updScrTsk, 1, NULL);
	vTaskStartScheduler();
